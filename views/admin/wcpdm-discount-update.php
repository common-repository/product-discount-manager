                                ...
                                <div class="updateSettings_wrapper">
                                    ...
                                    <?php
                                        ...
                                        foreach ($discountUpdateQuery as $key => $discountData) { 
                                            ...
                                            $discountAmount = isset($discountData->wcpd_discount_amount) ? floatval($discountData->wcpd_discount_amount) : 0.0;
                                                                ...
                                                                foreach ( $wcpd_categories as $category ) {
                                                                    ...
                                                                    echo'<div class="form-check">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                ...
                                                                                <span class="err_msg">'.esc_html('Error massage', 'product-discount-manager').'</span>
                                                                            </label>
                                                                        </div>';
                                                    ...
                                                    <td>
                                                        <div class="wcpd_sku_paid">
                                                            <select id="wcpd_productGroup" datatype="group" class="form-select wcpd_product_group wcpd_checkData wcpd_sku_paid wcpdm_responsive_width" aria-label="Default select" disabled="">
                                                                    <option value=""><?php esc_html_e( "Select Group", 'product-discount-manager' ); ?></option>                                                
                                                            </select>
                                                        </div>
                                                            ...
                                                            <?php 
                                                                if($discountSchedule){
                                                                    printf(
                                                                        ...
                                                                        '<input type="text" class="time start" name="timeStart" value="%s" /> <span>To</span>' .
                                                                        ...
                                                                        <input type="text" class="time start" name="timeStart" />  <span><?php esc_html_e( 'To', 'product-discount-manager' ); ?><span>
                                                    ...
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio"
                                                                value="regular" id="regular" name="apply_on" <?php echo ($discountApply_on == "regular") ? 'checked' : ''; ?> >
                                                            <label class="form-check-label"
                                                                for="regular">
                                    ...
                                    <button type="submit" id="saveUpdateSettings" class="btn wcpdm_btn_two btn-sm"><?php esc_html_e( 'Update Settings', 'product-discount-manager' ); ?></button>
                                </div>
